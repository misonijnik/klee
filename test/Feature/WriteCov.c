...
// RUN: grep -c WriteCov.c:17  %t.klee-out/test000001.cov %t.klee-out/test000002.cov  >%t3.txt
// RUN: grep -c WriteCov.c:20  %t.klee-out/test000001.cov %t.klee-out/test000002.cov >>%t3.txt
